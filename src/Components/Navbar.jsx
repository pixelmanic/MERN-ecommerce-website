...
export default function Navbar() {
  ...
  const handleInputChange = (event) => {
    ...
    if (products && products.length > 0 && value.trim() !== "") {
      ...
      // Handle the case when products is undefined or empty, or input value is empty
      setSearchResults([]);
    }
  };
  ...
  return (
    <>
      <header className="header">
        ...
        <nav>
          ...
          <div className="nav-third-div">
            ...
            <span className="nav-third-btns">Cart</span>
            <span className="nav-third-btns shop-cart-icon">
              <ShoppingOutlined 
            ...
            {searchResults && searchResults.length > 0 && (
              <div className="nav-products-wrapper">
                ...
                <div className="all-products-box">
                  <Link to="/search" className="main-button-black">
            ...
            {inputValue && searchResults.length === 0 && (
              <div className="search-results-wrapper">
                <div className="search-no-results">
                  No results found for "{inputValue}". Check the spelling or use
            ...
            <div className="cart-middle">
              <div className="cart-items">
                <div className="item-left">
                  <Link className="item-image">
                    <img
                      src="https://cdn.shopify.com/s/files/1/0515/3633/0928/files/Keila.7002310_taupe-and-stone_01.jpg?v=1689258863&width=300"
                      alt="product"
                ...
                <div className="item-right">
                  <div>
                    <p className="item-title">
                      <Link to={`/`}>
                        Keisha Coat{" "}
                        <span className="item-sub-title">taupe and stone</span>
                      </Link>
                      <span className="item-remove-btn">Remove</span>
                    </p>
                    <p className="item-prices">
                      <span className="item-price">€159.45</span>
                      <span className="item-prev-price">€159.45</span>
                    </p>
                  </div>
              ...
              <div className="cda-wrapper">
                <div className="cda-header">
                  ...
                  <span className="cda-hide"><MinusOutlined /></span>
                </div>
      ...
      ></div>
      <div
        className={`cart-overlay ${isMenuOpen ? "cart-open" : ""}`}
        onClick={menuToggle}
      ></div>
    </>
  );
